...
<table <?php tabel_in(100,'%',0,'center');  ?>>		
	<tbody>
				...
				<input type="hidden" class="form-control" readonly value="<?php echo $id_pelanggan_otomatis;?>" name="id_pelanggan" placeholder="id_pelanggan" id="id_pelanggan" required="required">		
