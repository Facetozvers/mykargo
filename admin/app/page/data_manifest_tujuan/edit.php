                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    <tr>
                        <td width="25%" class="leftrowcms">
                            <label>Id&nbsp;Manifest Tujuan <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                            <input type="text" name="id_manifest_tujuan"
                                   value="<?php echo $data['id_manifest_tujuan']; ?>"
                                   readonly id="id_manifest_tujuan" required="required">
                        </td>
                    </tr>
