...
{   
	...
	<?php
	action_cetak("data_manifest_tujuan");
}
else
{
	function location() { return "cetak"; }
	include '../../../include/all_include.php';
	proses_action_cetak("data_manifest_tujuan");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;manifest asal</th>
        <th class="th_border cell"  >awb</th>
<th class="th_border cell"  >qty</th>
<th class="th_border cell"  >kg</th>
<th class="th_border cell"  >isi paketan</th>
<th class="th_border cell"  >status</th>
<th class="th_border cell"  >alasan status</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_manifest_tujuan where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_manifest_tujuan where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";

				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_manifest_tujuan";
				}
...
<td align="center"><?php echo ($data['awb']); ?></td>
<td align="center"><?php echo ($data['qty']); ?></td>
<td align="center"><?php echo ($data['kg']); ?></td>
<td align="center"><?php echo (substr($data['isi_paketan'],0,100)); ?></td>
<td align="center"><?php echo (substr($data['status'],0,100)); ?></td>
<td align="center"><?php echo (substr($data['alasan_status'],0,100)); ?></td>
