                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    <tr>
                        <td width="25%" class="leftrowcms">
                            <label>id&nbsp;manifest tujuan <span class="highlight">*</span></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                            <input type="readonly" readonly
                                   value="<?php echo id_otomatis("data_manifest_tujuan", "id_manifest_tujuan", "10"); ?>"
                                   name="id_manifest_tujuan" placeholder="id_manifest_tujuan" id="id_manifest_tujuan"
                                   required="required">
                        </td>
                    </tr>
