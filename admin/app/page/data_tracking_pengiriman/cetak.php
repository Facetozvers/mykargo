...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_tracking_pengiriman");
} else {
    ...
    proses_action_cetak("data_tracking_pengiriman");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_tracking_pengiriman";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">Id Tracking Pengiriman </th>
            <th class="th_border cell">Nomor Resi </th>
            <th class="th_border cell">Id Driver </th>
            <th class="th_border cell">Lat </th>
            <th class="th_border cell">Lng </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_tracking_pengiriman where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_tracking_pengiriman where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_tracking_pengiriman";
            }
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <td align="center"><?php echo $data['id_tracking_pengiriman']; ?></td>
