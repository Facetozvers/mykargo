...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;informasi</th>
        <th class="th_border cell"  >judul</th>
<th class="th_border cell"  >tanggal</th>
<th class="th_border cell"  >isi</th>
<th class="th_border cell"  >foto</th>
    ...
    <?php
        ...
        <tr class="event2">
            ...
            <td align="center"><?php echo $data['id_informasi']; ?></td>
...
<td align="center"><a href='../../../../admin/upload/<?php echo $data['foto']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../../admin/upload/<?php echo $data['foto']; ?>'></a></td>
