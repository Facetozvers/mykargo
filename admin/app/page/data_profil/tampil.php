...
<table <?php tabel(100,'%',1,'left');  ?> >
			<tr>								  
			   ...
			   <th>No</th>
			   <th>Id&nbsp;profil</th>
			   <th align="center" class="th_border cell"  >Profil</th>
			   <th align="center" class="th_border cell"  >Home</th>
			...
			<?php
               ...
               <tr class="event2">	
                 ...
                 <td align="center"><?php echo (substr($data['home'],0,100)); ?></td>
                <td align="center"><?php echo (substr($data['profil'],0,100)); ?></td>
               </tr>
			<?php } ?>
			</tbody>
</table>
