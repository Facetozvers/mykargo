...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <hr class="message-inner-separator">
            <p>Silahkan input Data Driver  dibawah ini.</p>
        </div>
    </div>
                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_driver", "id_driver", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_driver", "id_driver", "10"); ?>" name="id_driver" placeholder="Id Driver " id="id_driver" required="required">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="varchar" name="no_ktp" id="no_ktp" placeholder="No Ktp " required="required">
                            </td>
                        </tr>
                          <tr>
                            <td width="25%" class="leftrowcms">
                            ...
                            <td width="2%">:</td>
                            <td>
                                <textarea class="form-control" style="width:50%" type="text" name="detail_informasi_driver" id="detail_informasi_driver" placeholder="Detail Informasi Driver " required="required"></textarea>
                            </td>
                        </tr>
                        </tr>
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <textarea class="form-control" style="width:50%" type="text" name="username" id="username" placeholder="Username " required="required"></textarea>
                            </td>
                        </tr>
						</tr>
                          <tr>
