...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_driver");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">No Ktp </th>
            <th class="th_border cell">Detail Informasi Driver </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_driver where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_driver where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_driver";
            }
