...
<div class="content-box">
    <div class="content-box-content">
        <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
            ...
            <tr>
                <td class="clleft" width="25%">No Ktp </td>
                <td class="clleft" width="2%">:</td>
                <td class="clleft"><?php echo $data['no_ktp']; ?></td>
            </tr>
            <tr>
                <td class="clleft" width="25%">Detail Informasi Driver </td>
                <td class="clleft" width="2%">:</td>
                <td class="clleft"><?php echo $data['detail_informasi_driver']; ?></td>
            </tr>
