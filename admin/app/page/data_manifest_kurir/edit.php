        ...
        <div class="content-box-content">
            <div id="postcustom">
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    $sql = mysql_query("SELECT * FROM data_manifest_kurir where id_manifest_kurir = '$proses'");
                    $data = mysql_fetch_array($sql);
                    ?>
                    <tr>
                        <td width="25%" class="leftrowcms">
                            <label>Id&nbsp;Manifest kurir <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                            <input type="text" name="id_manifest_kurir" value="<?php echo $data['id_manifest_kurir']; ?>"
                                   readonly id="id_manifest_kurir" required="required">
                        </td>
                    </tr>
