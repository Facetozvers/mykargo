                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    <tr>
                        <td width="25%" class="leftrowcms">
                            <label>id&nbsp;manifest kurir <span class="highlight">*</span></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                            <input type="readonly" readonly
                                   value="<?php echo id_otomatis("data_manifest_kurir", "id_manifest_kurir", "10"); ?>"
                                   name="id_manifest_kurir" placeholder="id_manifest_kurir" id="id_manifest_kurir" required="required">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="2%">:</td>
                        <td>
                            <textarea id="awb" name="awb" rows="10" cols="40"></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class=' selectpicker' data-live-search='true' required="required" type="enum"
                                ...
                                <?php combo_enum('data_manifest_kurir', 'status', ''); ?>
                            </select>
                        </td>
                    </tr>
