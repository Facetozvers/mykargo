...
<div class="content-box">
    ...
    <form action="proses_simpan.php" enctype="multipart/form-data" method="post">
            ...
            <div id="postcustom">
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    <tbody>
                            ...
                            <input
                                   type="hidden"  value="<?php echo id_otomatis("data_pengiriman", "nomor_resi", "10"); ?>"
        ...
        echo $nama = baca_database("","nama","select * from data_pelanggan where id_pelanggan = '$id_pelanggan'"); ?>" class="form-control"type="text" name="pengirim" id="pengirim" placeholder="Pengirim"
                                   required="required">
        ...
        echo $alamat_lengkap = baca_database("","alamat_lengkap","select * from data_pelanggan where id_pelanggan = '$id_pelanggan'"); ?></textarea>
                ...
                <div class="content-box-content">
                    <center>
                        <?php btn_simpan(' PROSES PENGIRIMAN '); ?>
                    </center>
                </div>
            </div>
        </div>
